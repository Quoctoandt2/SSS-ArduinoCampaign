 ...
 */
  ...
  * - khoang 300 neu anh sang manh nhu anh sang ban ngay
  ...
  * 
  * O day, de thuan tien, ta goi gia tri 500 la on_level
...
int Light_bulb = 13;      // Chung ta dat ten cho chan so 13 la Light_bulb, day cung la chan dieu khien den
